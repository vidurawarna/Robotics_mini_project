...
class input_var:
    ...
    def __init__(self,master,l):
        ...
        init_max = ['180','180','180','180']
        init_min = ['-180','-180','-180','-180']
...
class control_window:
    ...
    def send_to_arm(self):
        print([self.theta[i].get() for i in range(4)])
    ...
    def inverse_kinematics(self,event):
        joint_angles_default = [0,90,-90,-90]
        
        self.joint_angles=[]
        angles = []
        
        min_range = [0,0,225,90]
        max_range = [180,180,360,270]
